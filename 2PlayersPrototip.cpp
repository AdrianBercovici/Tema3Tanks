...
bool gameOver;
int mapSize,harta[maxMapSize][maxMapSize],nrOfAgents, A,S,D,W,AA,SS,DD,WW;
...
void Logic2()
{
    if(DD==1 && harta[Agents[1].pozitie.y][Agents[1].pozitie.x+1]==0){

        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=0;
        Agents[1].pozitie.x++;
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=2;
      //  tank.column++;
    }
    else if(AA==1 && harta[Agents[1].pozitie.y][Agents[1].pozitie.x-1]==0){
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=0;
        Agents[1].pozitie.x--;
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=2;
      //  tank.column--;
    ...
    else if(WW==1 && harta[Agents[1].pozitie.y-1][Agents[1].pozitie.x]==0){
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=0;
        Agents[1].pozitie.y--;
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=2;
        //tank.line--;
    }
    else if(SS==1 && harta[Agents[1].pozitie.y+1][Agents[1].pozitie.x]==0){
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=0;
        Agents[1].pozitie.y++;
        harta[Agents[1].pozitie.y][Agents[1].pozitie.x]=2;
       // tank.line++;
